create database travelext;
use travelext;
drop table travel;
create table travel(caseId VARCHAR(15) not null primary key, HolidayType VARCHAR(20), Price INTEGER, NumberOfPersons INTEGER, regionId bigint not null, Transportation VARCHAR(30), Duration INTEGER, Season VARCHAR(30), Accommodation VARCHAR(30), Hotel VARCHAR(50));
