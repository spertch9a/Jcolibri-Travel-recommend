 ...
 * 11/01/2007
 */
package com.demo.jcolibri.util;
...
public class ProgressController {
	...
	static Hashtable<Class, Collection<jcolibri.util.ProgressListener>> listeners = new Hashtable<Class, Collection<jcolibri.util.ProgressListener>>();
	static Collection<jcolibri.util.ProgressListener> listenersEverything = new ArrayList<jcolibri.util.ProgressListener>();
	 ...
	 */
	public static void register(jcolibri.util.ProgressListener pl, Class c)
	{
		Collection<jcolibri.util.ProgressListener> l = listeners.get(c);
		if(l==null)
		{
			l = new ArrayList<jcolibri.util.ProgressListener>();
			listeners.put(c, l);
		}
		l.add(pl);
	}
	 ...
	 */
	public static void register(jcolibri.util.ProgressListener pl)
	{
	 ...
	 */
	public static void deregister(jcolibri.util.ProgressListener pl, Class c)
	{
		Collection<jcolibri.util.ProgressListener> l = listeners.get(c);
		if(l!=null)
			l.remove(pl);
	 ...
	 */
	public static void deregister(jcolibri.util.ProgressListener pl)
	{
	...
	{
		Collection<jcolibri.util.ProgressListener> ls = listeners.get(c);
		if(ls!=null)
			for(jcolibri.util.ProgressListener pl: ls)
				pl.init(info, numberOfSteps);
		for(jcolibri.util.ProgressListener pl: listenersEverything)
			pl.init(info, numberOfSteps);
	}
