 ...
 * 11/11/2007
 */
package com.demo.jcolibri.extensions.recommendation.collaborative;
...
public class CollaborativeRetrievalMethod
{
     ...
     */
    public static Collection<RetrievalResult> getRecommendation(jcolibri.extensions.recommendation.collaborative.PearsonMatrixCaseBase cb, CBRQuery query, int kUsers)
    {
