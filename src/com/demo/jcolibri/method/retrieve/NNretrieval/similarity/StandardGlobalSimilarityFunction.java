 ...
 *
 */
public abstract class StandardGlobalSimilarityFunction implements jcolibri.method.retrieve.NNretrieval.similarity.GlobalSimilarityFunction
{
     ...
     * @see jcolibri.method.retrieve.NNretrieval.similarity.GlobalSimilarityFunction#compute(CaseComponent, CaseComponent, CBRCase, CBRQuery, NNConfig)
     */
	...
	for(int i=0; i<attributes.length; i++)
	{
		...
		{
       		    	if(lsf instanceof jcolibri.method.retrieve.NNretrieval.similarity.InContextLocalSimilarityFunction)
       		    	{
       		    	    jcolibri.method.retrieve.NNretrieval.similarity.InContextLocalSimilarityFunction iclsf = (InContextLocalSimilarityFunction)lsf;
