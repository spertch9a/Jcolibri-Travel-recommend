 ...
 * 28/10/2007
 */
package com.demo.jcolibri.method.retrieve.FilterBasedRetrieval;
...
public class FilterBasedRetrievalMethod
{
     ...
     */
    public static Collection<CBRCase> filterCases(Collection<CBRCase> cases, CBRQuery query, jcolibri.method.retrieve.FilterBasedRetrieval.FilterConfig filterConfig)
    {
