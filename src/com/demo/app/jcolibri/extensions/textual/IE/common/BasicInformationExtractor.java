/**
 * BasicInformationExtractor.java
 * jCOLIBRI2 framework. 
 ...
 * into the other attributes of the component.<br>
...
public class BasicInformationExtractor
{
    ...
    {
	org.apache.commons.logging.LogFactory.getLog(BasicInformationExtractor.class).info("Extracting query information.");
	...
	try
	{
		...
		if (o instanceof CaseComponent)
		    extractInformation((CaseComponent) o);
		...
		if (at.getType().equals(String.class))
		{
			...
			org.apache.commons.logging.LogFactory.getLog(BasicInformationExtractor.class).debug("Adding features to attribute: "+at.getName()+" <- "+value);
		    }
		...
		} else if (at.getType().equals(Boolean.class))
		{
			...
			if (p.getPhrase().equalsIgnoreCase(name))
			{
			    ...
			    org.apache.commons.logging.LogFactory.getLog(BasicInformationExtractor.class).debug("Enabling attribute: "+at.getName()+". Source: "+p.getPhrase());
