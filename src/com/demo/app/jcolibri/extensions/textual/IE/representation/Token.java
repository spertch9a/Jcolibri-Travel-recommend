...
/**
 * A token represents an elementary piece of text. It is usually a word or punctuation symbol.
 * This object stores some flags extracted by specific methods:
 * <ul>
...
public class Token {
	...
	{
		return "    [TOKEN: "+getRawContent()+", stem: "+stem+", POSTAG: "+postag+", isStopWord?: "+stopWord+", isMainName?:"+isMainName+"]\n";
	}
