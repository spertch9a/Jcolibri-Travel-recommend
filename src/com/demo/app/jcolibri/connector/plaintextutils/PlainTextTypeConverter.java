package com.demo.app.jcolibri.connector.plaintextutils;
...
public class PlainTextTypeConverter {
	...
	public static Object convert(String data, Class type) {
		try {
			...
			org.apache.commons.logging.LogFactory.getLog(PlainTextTypeConverter.class).error("Error converting types: " + e.getMessage());
		}
