...
public class TextualSimUtils
{
     ...
     * The expansion means that new tokens are added to the returned sets depending on
     * the WeightedRelations between the tokens of the case and the query
     * @param caseTokens Input tokens of the case
     * @param queryToken Input tokens of the query
