 ...
 * 07/05/2007
 */
package com.demo.app.jcolibri.evaluation.evaluators;
			...
			List<CBRCase> querySet, List<CBRCase> casebaseSet, String filename)
	{
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				if(c==null)
				{
					org.apache.commons.logging.LogFactory.getLog(this.getClass()).error("Case "+line+" not found into case base");
					continue;
				}
